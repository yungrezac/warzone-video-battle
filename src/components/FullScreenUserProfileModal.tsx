...
const FullScreenUserProfileModal: React.FC<FullScreenUserProfileModalProps> = ({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="w-full h-full max-w-none max-h-none m-0 p-0 rounded-none bg-gray-50 flex flex-col" 
        hideCloseButton
      >
        {/* Header with back button - fixed at top */}
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-3 flex items-center flex-shrink-0 z-50">
          <Button 
            variant="ghost" 
            size="sm" 
