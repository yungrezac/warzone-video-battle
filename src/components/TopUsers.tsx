    ...
    return (
      <div className="bg-gray-50 min-h-screen">
        ...
        {topUsers && topUsers.length >= 3 && (
          <div className="p-4 pt-6 pb-6 text-center bg-white border-b border-gray-200 py-[44px] px-[18px]">
            <div className="flex justify-center items-end space-x-2">
              {/* 2nd place */}
              <div className="flex flex-col items-center w-1/4 cursor-pointer" onClick={() => handleUserClick(topUsers[1]?.user?.id)}>
              ...
              {/* 1st place */}
              <div className="flex flex-col items-center w-1/3 cursor-pointer" onClick={() => handleUserClick(topUsers[0]?.user?.id)}>
                <div className="relative">
              ...
              {/* 3rd place */}
              <div className="flex flex-col items-center w-1/4 cursor-pointer" onClick={() => handleUserClick(topUsers[2]?.user?.id)}>
                <div className="relative">
          ...
          <div className="bg-white rounded-lg shadow-sm">
            ...
            <div className="divide-y divide-gray-100">
              {topUsers?.map((userPoint, index) => (
                <div key={userPoint.id} className="p-3 flex items-center space-x-3 hover:bg-gray-50 transition-colors cursor-pointer" onClick={() => handleUserClick(userPoint.user?.id)}>
      ...
      <Tabs defaultValue="top" className="w-full">
        <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
          <TabsList className="grid w-full grid-cols-2 bg-transparent p-0 h-auto">
            <TabsTrigger 
              value="top" 
              className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600 rounded-none py-3 px-4 font-medium text-gray-600 hover:text-gray-800 transition-colors"
            >
              Топ
            </TabsTrigger>
            <TabsTrigger 
