  ...
  return (
    <div className="pb-16">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-3">
        ...
        {/* Points Section with Withdrawal Button */}
          ...
          <div className="bg-white bg-opacity-20 rounded-lg p-2 text-center relative">
            ...
            {isPremium && (
              <Button
                ...
                className="absolute -top-1 -right-1 w-6 h-6 p-0 bg-green-500 hover:bg-green-600 text-white rounded-full"
              >
      ...
      <div className="p-2">
        {/* Premium Section - only show if user has premium */}
        {isPremium && (
        ...
        {/* Premium Promotion - only for non-premium users */}
        {!isPremium && (
          <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white rounded-lg p-3 mb-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm opacity-90">
                  Турниры, вывод баллов и многое другое
                </p>
              </div>
              <SubscriptionModal>
                <Button 
