...
import { Trophy, Target, Award, Star, X } from 'lucide-react';
...
const Achievements: React.FC<AchievementsProps> = ({ isOpen, onClose }) => {
  ...
  if (!user) {
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-md max-h-[90vh] overflow-hidden p-4">
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-hidden p-0">
        <div className="h-full flex flex-col">
          {/* Header */}
          <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-4 flex items-center justify-between">
